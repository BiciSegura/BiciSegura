...
public class Pestañas_entrega3 extends Fragment {
    TabItem rutas;
    ViewPager viewPager;
    TabLayout tablayout;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.pestanas_entrega3, container, false);
        ...
        rutas = view.findViewById(R.id.RT);
