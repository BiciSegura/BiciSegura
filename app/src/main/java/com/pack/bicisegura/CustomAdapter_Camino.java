...
public class CustomAdapter_Camino extends ArrayAdapter<Localidad>{

    private List<Localidad> lista;
    private Context mContext;
    private int resourceLayout;

    public CustomAdapter_Camino(@NonNull Context context, int resource, List<Localidad> objects) {
